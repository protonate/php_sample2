...
<link href="<?php echo $style_prefix;?>intro.css" rel="stylesheet" type="text/css" />
<?php echo $extra_stylesheet;?>
  ...
  <script language="javascript" type="text/javascript" src="js/intro2.js"></script>
...
<div id="container">
    ...
    <div id="page2">
      ...
      <a class="paranblock" target="_blank" id="newsflash" href=""><b>NEWSFLASH:</b> US Book Release February 1st!</a>
...
<!--      <a class="paranblock" target="_blank" id="preorder" href="http://www.barnesandnoble.com/w/sex-diaries-project-arianne-cohen/1100642951?ean=9781118157251&itm=1&usri=the%2bsex%2bdiaries%2bproject">Pre-order the Book</a>
      ...
      <a class="paranblock" id="getstarted" href="https://sexdiariesproject.com/account/en-index.php">Get Started: Keep a Diary</a> -->
  <?php 
...
?>
      ...
      <div id="tooltip">
        ...
        <span id="tooltext">A present! Just for you. Free. The Quickie is an art project that lives in your inbox: a new Diary or photograph or podcast, semi-daily. You can unsubscribe anytime. And we won't sell your email. Because we don't know how. Promise.</span>
      </div>
      </div>
  ...
  <style>
  #title, #leftparan, #slipbetween, #page2 {
      left: 235px;
  }
  #cursor{
      left:485px;
